...
# --- YOLO/CV Settings ---
CAMERA_INDEX = 0  # 0 for default webcam, adjust for dedicated device camera
FRAME_WIDTH = 320   # REDUCED: Improves performance dramatically
FRAME_HEIGHT = 320  # REDUCED: Improves performance dramatically
FRAME_SKIP = 2      # NEW: Process only 1 out of every 2 frames for speed
...
# Adjust these based on your real-world testing!
